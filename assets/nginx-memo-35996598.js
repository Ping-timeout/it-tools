import{o,c as r,a as s,d as l,c8 as m,c9 as c,k as p,l as t,bm as d}from"./index-3ff32cc2.js";const _={class:"markdown-body"},u=s("pre",null,[s("code",{class:"language-bash"},`##############################################################################
# NGINX
...
`)],-1),x=[u],v={__name:"nginx-memo.content",setup(a,{expose:n}){return n({frontmatter:{}}),(i,g)=>(o(),r("div",_,x))}},h=l({__name:"nginx-memo",setup(a){m(e=>({"5c62344e":t(n).cardColor}));const n=c();return(e,i)=>(o(),r("div",null,[p(t(v))]))}});const w=d(h,[["__scopeId","data-v-36391df5"]]);export{w as default};
