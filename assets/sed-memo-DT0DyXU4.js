import{A as e,E as t,F as n,O as r,Tt as i,a,lt as o,q as s,s as c,w as l}from"./vue.runtime.esm-bundler-C0qeGFLU.js";import{t as u}from"./use-theme-vars-D12EPShX.js";import{t as d}from"./_plugin-vue_export-helper-BDNMzG2s.js";n();var f={class:`markdown-body`},p={__name:`sed`,setup(e,{expose:n}){return n({frontmatter:{}}),(e,n)=>(s(),l(`div`,f,[...n[0]||=[t(`<h1>🧾 <code>sed</code> Command Cheatsheet (Stream Editor)</h1><p><code>sed</code> is a powerful Unix utility for parsing and transforming text using <strong>stream editing</strong>.</p><h2>📌 Basic Syntax</h2><pre><code class="language-bash">sed [OPTIONS] &#39;script&#39; [file...]
...
</code></pre><h2>📚 Resources</h2><ul><li><code>man sed</code></li><li>GNU sed manual: <a href="https://www.gnu.org/software/sed/manual/sed.html">https://www.gnu.org/software/sed/manual/sed.html</a></li></ul>`,64)]]))}};a(),n(),o();var m=d(e({__name:`sed-memo`,setup(e){c(e=>({v8dba7e1e:i(t).cardColor,v9a5b4486:i(t).textColor1}));let t=u();return(e,t)=>(s(),l(`div`,null,[r(i(p),{style:{"overflow-x":`auto`}})]))}}),[[`__scopeId`,`data-v-3d35be74`]]);export{m as default};