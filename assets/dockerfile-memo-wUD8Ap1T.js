import{A as e,E as t,F as n,O as r,Tt as i,a,lt as o,q as s,s as c,w as l}from"./vue.runtime.esm-bundler-C0qeGFLU.js";import{t as u}from"./use-theme-vars-D12EPShX.js";import{t as d}from"./_plugin-vue_export-helper-BDNMzG2s.js";n();var f={class:`markdown-body`},p={__name:`dockerfile`,setup(e,{expose:n}){return n({frontmatter:{}}),(e,n)=>(s(),l(`div`,f,[...n[0]||=[t(`<p>A <strong>Dockerfile</strong> is a script composed of instructions to build a Docker image. Each instruction creates a layer in the image.</p><h2>📦 Basic Structure</h2><pre><code class="language-Dockerfile"># Comment
...
</code></pre>`,78)]]))}};a(),n(),o();var m=d(e({__name:`dockerfile-memo`,setup(e){c(e=>({v053abb51:i(t).cardColor,v2c8ca146:i(t).textColor1}));let t=u();return(e,t)=>(s(),l(`div`,null,[r(i(p),{style:{"overflow-x":`auto`}})]))}}),[[`__scopeId`,`data-v-7ae970ea`]]);export{m as default};