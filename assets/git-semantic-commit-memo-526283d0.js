import{o as n,c as i,T as r,d as c,c8 as l,c9 as d,k as p,l as o,bm as m}from"./index-3ff32cc2.js";const h={class:"markdown-body"},g=r(`<h1>Conventional Commits Cheatsheet</h1><h2>Structure</h2><p>A conventional commit message follows this structure:</p><pre><code>&lt;type&gt;[optional scope]: &lt;description&gt;
...
</code></pre>`,53),u=[g],f={__name:"git-sem.memo",setup(s,{expose:e}){return e({frontmatter:{}}),(a,_)=>(n(),i("div",h,u))}},v=c({__name:"git-semantic-commit-memo",setup(s){l(t=>({"287bb660":o(e).cardColor}));const e=d();return(t,a)=>(n(),i("div",null,[p(o(f))]))}});const y=m(v,[["__scopeId","data-v-19371e59"]]);export{y as default};
