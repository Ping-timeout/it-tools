import{A as e,F as t,O as n,Tt as r,a as i,lt as a,q as o,s,w as c,x as l}from"./vue.runtime.esm-bundler-C0qeGFLU.js";import{t as u}from"./use-theme-vars-D12EPShX.js";import{t as d}from"./_plugin-vue_export-helper-BDNMzG2s.js";t();var f={class:`markdown-body`},p={__name:`nginx-memo.content`,setup(e,{expose:t}){return t({frontmatter:{}}),(e,t)=>(o(),c(`div`,f,[...t[0]||=[l(`pre`,null,[l(`code`,{class:`language-bash`},`##############################################################################
# NGINX
...
`)],-1)]]))}};i(),t(),a();var m=d(e({__name:`nginx-memo`,setup(e){s(e=>({v5c62344e:r(t).cardColor}));let t=u();return(e,t)=>(o(),c(`div`,null,[n(r(p))]))}}),[[`__scopeId`,`data-v-36391df5`]]);export{m as default};