import{A as ee,bo as oe,bp as E,r as k,bq as I,br as P,bs as V,at as A,ay as B,an as _,aq as m,ap as C,am as F,aD as T,d as te,u as $,aP as ne,au as re,i as U,av as D,ax as ae,bt as ie,h as G,aH as de}from"./index-3ff32cc2.js";import{g as se}from"./get-slot-1efb97e5.js";const he={name:String,value:{type:[String,Number,Boolean],default:"on"},checked:{type:Boolean,default:void 0},defaultChecked:Boolean,disabled:{type:Boolean,default:void 0},label:String,size:String,onUpdateChecked:[Function,Array],"onUpdate:checked":[Function,Array],checkedValue:{type:Boolean,default:void 0}},H=ee("n-radio-group");function ve(e){const o=oe(H,null),n=E(e,{mergedSize(t){const{size:a}=e;if(a!==void 0)return a;if(o){const{mergedSizeRef:{value:d}}=o;if(d!==void 0)return d}return t?t.mergedSize.value:"medium"},mergedDisabled(t){return!!(e.disabled||o?.disabledRef.value||t?.disabled.value)}}),{mergedSizeRef:b,mergedDisabledRef:r}=n,s=k(null),u=k(null),l=k(e.defaultChecked),f=I(e,"checked"),g=P(f,l),v=V(()=>o?o.valueRef.value===e.value:g.value),R=V(()=>{const{name:t}=e;if(t!==void 0)return t;if(o)return o.nameRef.value}),h=k(!1);function x(){if(o){const{doUpdateValue:t}=o,{value:a}=e;B(t,a)}else{const{onUpdateChecked:t,"onUpdate:checked":a}=e,{nTriggerFormInput:d,nTriggerFormChange:i}=n;t&&B(t,!0),a&&B(a,!0),d(),i(),l.value=!0}}function p(){r.value||v.value||x()}function y(){p(),s.value&&(s.value.checked=v.value)}function z(){h.value=!1}function S(){h.value=!0}return{mergedClsPrefix:o?o.mergedClsPrefixRef:A(e).mergedClsPrefixRef,inputRef:s,labelRef:u,mergedName:R,mergedDisabled:r,renderSafeChecked:v,focus:h,mergedSize:b,handleRadioInputChange:y,handleRadioInputBlur:z,handleRadioInputFocus:S}}const ue=_("radio-group",`
