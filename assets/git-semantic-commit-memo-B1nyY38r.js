import{A as e,E as t,F as n,O as r,Tt as i,a,lt as o,q as s,s as c,w as l}from"./vue.runtime.esm-bundler-C0qeGFLU.js";import{t as u}from"./use-theme-vars-D12EPShX.js";import{t as d}from"./_plugin-vue_export-helper-BDNMzG2s.js";n();var f={class:`markdown-body`},p={__name:`git-sem.memo`,setup(e,{expose:n}){return n({frontmatter:{}}),(e,n)=>(s(),l(`div`,f,[...n[0]||=[t(`<h1>Conventional Commits Cheatsheet</h1><h2>Structure</h2><p>A conventional commit message follows this structure:</p><pre><code>&lt;type&gt;[optional scope]: &lt;description&gt;
...
</code></pre>`,53)]]))}};a(),n(),o();var m=d(e({__name:`git-semantic-commit-memo`,setup(e){c(e=>({v287bb660:i(t).cardColor}));let t=u();return(e,t)=>(s(),l(`div`,null,[r(i(p))]))}}),[[`__scopeId`,`data-v-19371e59`]]);export{m as default};