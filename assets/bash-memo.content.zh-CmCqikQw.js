import{F as e,q as t,w as n,x as r}from"./vue.runtime.esm-bundler-C0qeGFLU.js";e();var i={class:`markdown-body`},a={__name:`bash-memo.content.zh`,setup(e,{expose:a}){return a({frontmatter:{}}),(e,a)=>(t(),n(`div`,i,[...a[0]||=[r(`pre`,null,[r(`code`,{class:`language-bash`},`#!/bin/bash
##############################################################################
# 快捷键和历史记录
##############################################################################
