import{A as e,E as t,F as n,O as r,Tt as i,a,lt as o,q as s,s as c,w as l}from"./vue.runtime.esm-bundler-C0qeGFLU.js";import{t as u}from"./use-theme-vars-D12EPShX.js";import{t as d}from"./_plugin-vue_export-helper-BDNMzG2s.js";n();var f={class:`markdown-body`},p={__name:`docker-swarm`,setup(e,{expose:n}){return n({frontmatter:{}}),(e,n)=>(s(),l(`div`,f,[...n[0]||=[t(`<p><strong>Docker Swarm Mode</strong> is Docker’s native clustering and orchestration solution. It allows you to manage a group of Docker nodes as a single virtual system, enabling high availability, load balancing, and simplified deployment of containerized applications.</p><p>Key features:</p><ul><li>Built-in orchestration</li><li>Declarative service model</li><li>Rolling updates</li><li>Auto-scaling and self-healing</li><li>Secure node communication via TLS</li></ul><h2>📌 Swarm Initialization</h2><ul><li><p><strong>Initialize Swarm</strong></p><pre><code class="language-bash">docker swarm init
  ...
  --network webnet \\
  nginx
</code></pre>`,29)]]))}};a(),n(),o();var m=d(e({__name:`docker-swarm-memo`,setup(e){c(e=>({v53645f1f:i(t).cardColor,v60c4854f:i(t).textColor1}));let t=u();return(e,t)=>(s(),l(`div`,null,[r(i(p),{style:{"overflow-x":`auto`}})]))}}),[[`__scopeId`,`data-v-9eb362f2`]]);export{m as default};