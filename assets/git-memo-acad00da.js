import{o as n,c as t,T as r,d as l,c8 as g,c9 as i,k as p,l as c,bm as d}from"./index-3ff32cc2.js";const h={class:"markdown-body"},m=r(`<h2>Configuration</h2><p>Set the global config</p><pre><code class="language-shell">git config --global user.name &quot;[name]&quot;
...
</code></pre>`,44),u=[m],_={__name:"git-memo.content",setup(o,{expose:e}){return e({frontmatter:{}}),(s,f)=>(n(),t("div",h,u))}},b=l({__name:"git-memo",setup(o){g(a=>({"8cb22b3c":c(e).cardColor}));const e=i();return(a,s)=>(n(),t("div",null,[p(c(_))]))}});const C=d(b,[["__scopeId","data-v-c7dbeca3"]]);export{C as default};
